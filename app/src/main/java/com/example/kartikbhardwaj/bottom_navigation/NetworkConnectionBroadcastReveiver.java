...
public class NetworkConnectionBroadcastReveiver extends BroadcastReceiver {
    ...
    private boolean isConnectedToInternet(Context context) {
        try {
            ...
            Log.e(NetworkConnectionBroadcastReveiver.class.getName(), e.getMessage());
            return false;
        }
    }
}
